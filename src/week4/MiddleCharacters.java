...
public class MiddleCharacters {
    public static void main(String[] args) {
        ...
        if (word.length() % 2 == 0){ // java -> 4 / 2 = 2
            ...
            firstPart = word.substring(0, middleIndex - 1); // java -> j
            middlePart = word.substring(middleIndex - 1, middleIndex + 1); // java -> AV
            ...
            middlePart = "" + word.charAt(middleIndex); // or word.substring(middleIndex, middleIndex + 1)
            middlePart = middlePart.toUpperCase();
            lastPart = word.substring(middleIndex + 1);
